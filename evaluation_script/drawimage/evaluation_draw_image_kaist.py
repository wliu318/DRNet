...
def drawtxt_to_image(imagepath, txtpath, dataset, method):
    ...
    for fnRGB, fnIR in tqdm(zip(filenameRGB,filenameIR)):
        ...
        for line in lines:
            ...
            if conf > 25 and txt_image_id == imageid:
...
if __name__ == "__main__":
    ...
    drawtxt_to_image("E:\\deeplearning\\dataset\\kaist icaf\\", args.rstFiles, "kaist icaf", "gt_kaist")
    #
    # args.rstFiles = './evaluation_script/state_of_arts/AR-CNN_result.txt'
    # drawtxt_to_image("E:\\deeplearning\\dataset\\kaist_icaf\\", args.rstFiles, "kaist_icaf", "AR-CNN")

    # args.rstFiles = './evaluation_script/state_of_arts/kaist/CIANet_result.txt'
    # drawtxt_to_image("E:\\deeplearning\\dataset\\kaist_icaf\\", args.rstFiles, "kaist_icaf", "CIANet")

    # args.rstFiles = './evaluation_script/state_of_arts/MBNet_result.txt'
    # drawtxt_to_image("E:\\deeplearning\\dataset\\kaist_icaf\\", args.rstFiles, "kaist_icaf", "MBNet")

    # args.rstFiles = './evaluation_script/state_of_arts/MLPD_result.txt'
    # drawtxt_to_image("E:\\deeplearning\\dataset\\kaist_icaf\\", args.rstFiles, "kaist_icaf", "MLPD")

    # args.rstFiles = './evaluation_script/state_of_arts/MSDS-RCNN_result.txt'
    # drawtxt_to_image("E:\\deeplearning\\dataset\\kaist_icaf\\", args.rstFiles, "kaist_icaf", "MSDS-RCNN")
    #
    # args.rstFiles = './evaluation_script/state_of_arts/Ours_result.txt'
    # drawtxt_to_image("E:\\deeplearning\\dataset\\kaist_icaf\\", args.rstFiles, "kaist_icaf", "Ours")
