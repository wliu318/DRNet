...
if __name__ == "__main__":
    ...
    args.rstFiles = './evaluation_script/state_of_arts/ARCNN_result.txt'
    ...
    # args.rstFiles = './evaluation_script/state_of_arts/flir/YOLOV5_T_result.txt'
    ...
    #
    # args.rstFiles = './evaluation_script/state_of_arts/flir/YOLOV5_RGBT_concat_result.txt'
    ...
    #
    # args.rstFiles = './evaluation_script/state_of_arts/flir/ICAF_RGBT_result.txt'
    # ICAF_RGBT_results = [evaluate(args.annFile, args.rstFiles, phase)]
    # ICAF_RGBT_results = sorted(ICAF_RGBT_results, key=lambda x: x['all'].summarize(0), reverse=True)
    #
    # args.rstFiles = './evaluation_script/state_of_arts/flir/DANetV1_result.txt'
    # DANetV1_results = [evaluate(args.annFile, args.rstFiles, phase)]
    # DANetV1_results = sorted(DANetV1_results, key=lambda x: x['all'].summarize(0), reverse=True)
    #
    # args.rstFiles = './evaluation_script/state_of_arts/flir/DANetV2_result.txt'
    # DANetV2_results = [evaluate(args.annFile, args.rstFiles, phase)]
    # DANetV2_results = sorted(DANetV2_results, key=lambda x: x['all'].summarize(0), reverse=True)

    compare_result = {
        'AR-CNN': copy.deepcopy(ARCNN_results),
        # 'YOLOV5_T': copy.deepcopy(YOLOV5_T_results),
        # 'YOLOV5_RGBT': copy.deepcopy(YOLOV5_RGBT_results),
        # 'ICAF_RGBT': copy.deepcopy(ICAF_RGBT_results),
        # 'DANetV1': copy.deepcopy(DANetV1_results),
        # 'DANetV2': copy.deepcopy(DANetV2_results),
    }
