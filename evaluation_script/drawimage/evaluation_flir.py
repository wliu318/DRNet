...
#
#
# mycolors = myColors()  # create instance for 'from utils.plots import colors'
...
if __name__ == "__main__":
    ...
    args.rstFiles = './evaluation_script/state_of_arts/flir2/Theraml_result.txt'
    ...
    args.rstFiles = './evaluation_script/state_of_arts/flir2/RGB+Theraml_result.txt'
    ...
    args.rstFiles = './evaluation_script/state_of_arts/flir2/RGB+Theraml+CAFE_result.txt'
    ...
    args.rstFiles = './evaluation_script/state_of_arts/flir2/RGB+Theraml+SAFE_result.txt'
    ...
    args.rstFiles = './evaluation_script/state_of_arts/flir2/RGB+Theraml+DCSAFM_result.txt'
    ...
    compare_result = {
        ...
        'Theraml': copy.deepcopy(YOLOv5_T_results),
        'RGB+Theraml': copy.deepcopy(YOLOv5_RGBT_results),
        'RGB+Theraml+CAFE': copy.deepcopy(YOLOv5_DCAFE_results),
        'RGB+Theraml+SAFE': copy.deepcopy(YOLOv5_SAFE_results),
        'RGB+Theraml+DCSAFM': copy.deepcopy(ours_results),
    }
    ...
    #     'Ours(DCSAFNet)': copy.deepcopy(Ours_results),
    # }
    #
    # # Sort results by MR_all
    # draw_allresult(compare_result, filename=args.evalFig)
