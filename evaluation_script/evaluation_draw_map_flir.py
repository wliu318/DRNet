...
if __name__ == "__main__":
    ...
    #
    # args.rstFiles = './evaluation_script/state_of_arts/flir/YOLOv5+RGB_result.txt'
    ...
    # # drawtxt_to_image("E:\\deeplearning\\dataset\\FLIR-align-3class\\", args.rstFiles, "flir", "YOLOv5+RGB")
    #
    #
    # args.rstFiles = './evaluation_script/state_of_arts/flir/YOLOv5+T_result.txt'
    ...
    # # drawtxt_to_image("E:\\deeplearning\\dataset\\FLIR-align-3class\\", args.rstFiles, "flir", "YOLOv5+T")
    #
    # args.rstFiles = './evaluation_script/state_of_arts/flir/YOLOv5+RGBT_result.txt'
    ...
    # # drawtxt_to_image("E:\\deeplearning\\dataset\\FLIR-align-3class\\", args.rstFiles, "flir", "YOLOv5+RGBT")
    #
    # args.rstFiles = './evaluation_script/state_of_arts/flir/YOLOv5+RGBT+DCAFE_result.txt'
    ...
    # # drawtxt_to_image("E:\\deeplearning\\dataset\\FLIR-align-3class\\", args.rstFiles, "flir", "YOLOv5+RGBT+DCAFE")
    #
    # args.rstFiles = './evaluation_script/state_of_arts/flir/YOLOv5+RGBT+SAFE_result.txt'
    ...
    # # drawtxt_to_image("E:\\deeplearning\\dataset\\FLIR-align-3class\\", args.rstFiles, "flir", "YOLOv5+RGBT+SAFE")
    #
    # args.rstFiles = './evaluation_script/state_of_arts/flir/Ours(DCSAFN)_result.txt'
    ...
    # # drawtxt_to_image("E:\\deeplearning\\dataset\\FLIR-align-3class\\", args.rstFiles, "flir", "Ours(DCSAFN)")
    # #
    # compare_result = {
    #     'YOLOv5+RGB': copy.deepcopy(YOLOv5_RGB_results),
    #     'YOLOv5+T': copy.deepcopy(YOLOv5_T_results),
    #     'YOLOv5+RGBT': copy.deepcopy(YOLOv5_RGBT_results),
    #     'YOLOv5+DCAFE': copy.deepcopy(YOLOv5_DCAFE_results),
    #     'YOLOv5+SAFE': copy.deepcopy(YOLOv5_SAFE_results),
    ...
    args.rstFiles = './evaluation_script/state_of_arts/kaist/Ours_result.txt'
    Ours_results = [evaluate(args.annFile, args.rstFiles, phase)]
    Ours_results = sorted(Ours_results, key=lambda x: x['all'].summarize(0), reverse=True)
