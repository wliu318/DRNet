...
if __name__ == "__main__":
    ...
    # corruption\\dual_modal\\day_rgblost, night_irlost

    args.rstFiles = '.\\state_of_arts\\flir\\gt_flir_night_irlost_result.txt'
    drawtxt_to_image("E:\\deeplearning\\dataset\\flir\\corruption\\dual_modal\\night_irlost", args.rstFiles, "flir_night_irlost", "Ground truth")

    args.rstFiles = '.\\state_of_arts\\flir\\cdcyolofusion\\flir_ir_rgb_45_night_irlost\\cdcyolofusion_flir_result.txt'
    drawtxt_to_image("E:\\deeplearning\\dataset\\flir\\corruption\\dual_modal\\night_irlost", args.rstFiles, "flir_night_irlost", "cdcyolofusion")

    args.rstFiles = '.\\state_of_arts\\flir\\cft\\flir_ir_rgb_45_night_irlost\\cft_flir_result.txt'
    drawtxt_to_image("E:\\deeplearning\\dataset\\flir\\corruption\\dual_modal\\night_irlost", args.rstFiles, "flir_night_irlost", "cft")

    args.rstFiles = '.\\state_of_arts\\flir\\dacfusion\\flir_ir_rgb_45_night_irlost\\dacfusion_flir_result.txt'
    drawtxt_to_image("E:\\deeplearning\\dataset\\flir\\corruption\\dual_modal\\night_irlost", args.rstFiles, "flir_night_irlost", "dacfusion")

    args.rstFiles = '.\\state_of_arts\\flir\\deyolo\\flir_ir_rgb_45_night_irlost\\deyolo_flir_result.txt'
    drawtxt_to_image("E:\\deeplearning\\dataset\\flir\\corruption\\dual_modal\\night_irlost", args.rstFiles, "flir_night_irlost", "deyolo")

    args.rstFiles = '.\\state_of_arts\\flir\\icaf\\flir_ir_rgb_45_night_irlost\\icaf_flir_result.txt'
    drawtxt_to_image("E:\\deeplearning\\dataset\\flir\\corruption\\dual_modal\\night_irlost", args.rstFiles, "flir_night_irlost", "icaf")

    args.rstFiles = '.\\state_of_arts\\flir\\mstf\\flir_ir_rgb_45_night_irlost\\mstf_flir_result.txt'
    drawtxt_to_image("E:\\deeplearning\\dataset\\flir\\corruption\\dual_modal\\night_irlost", args.rstFiles, "flir_night_irlost", "mstf")

    args.rstFiles = '.\\state_of_arts\\flir\\ours\\flir_ir_rgb_45_night_irlost\\ours_flir_result.txt'
    drawtxt_to_image("E:\\deeplearning\\dataset\\flir\\corruption\\dual_modal\\night_irlost", args.rstFiles, "flir_night_irlost", "ours")