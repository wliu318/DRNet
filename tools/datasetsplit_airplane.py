...
source_path = 'E:/deeplearning/dataset/nwpu_vhr_10/yolo/test_mix_airplane'  # 原始的标签路径

save_file_path = 'E:/deeplearning/dataset/nwpu_vhr_10/yolo/test_only_airplane'  # 修改后的标签路径
